...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/system/build.prop)
...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/system/build.prop)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/nx501/obj/EXECUTABLES/mm-vdec-omx-test*_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/symbols/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/nx501/obj/EXECUTABLES/charger_touch_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/symbols/system/bin/charger_touch)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/system/bin/charger_touch)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/obj/NOTICE_FILES/src/system/bin/charger_touch.txt)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/nx501/root/default.prop)
